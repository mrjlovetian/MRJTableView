...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.tableViewIndex = [[BATableViewIndex alloc] initWithFrame:CGRectMake(self.tableView.frame.size.width - 20, 0, 20, frame.size.height)];
        [self addSubview:self.tableViewIndex];
        
        self.flotageLabel = [[UILabel alloc] initWithFrame:CGRectMake((self.bounds.size.width - 64 ) / 2,(self.bounds.size.height - 64) / 2, 64, 64)];
